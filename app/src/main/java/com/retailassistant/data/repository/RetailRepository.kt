...
/**
 * The central authority for all data operations, abstracting data sources from the application.
 * It provides a clean API for the UI layer to interact with data, handling the complexities
 * of local caching, remote synchronization, and offline-first logic.
 */
